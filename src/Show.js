...
# 技能
* 职业方向: ${DIRECTIONS[skill.direction].label}  工作经验: ${getLabel(TIME, skill.direction_time)}
* 期望从事的职位
${skill.positions_time.map(({position, time}) => 
...
# 教育经历
${experience.educationRecords.map(({school, degree, major, duration}) => (
  `
* ${school}  ${degree}
  * 专业: ${major}
