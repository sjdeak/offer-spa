import {Button, Form, Input, InputNumber, message, Radio, Row, Select} from "antd"
      ...
      <Form onSubmit={this.handleSubmit}>
        ...
        <FormItem label={"姓名"}>
          {getFieldDecorator("name", {
            rules: [{required: true, message: "请输入您的中文姓名"}]
          })(<Input/>)}
        </FormItem>
        ...
        <FormItem label={"年龄"}>
          {getFieldDecorator("age")(<InputNumber min={15} max={75}/>)}
        </FormItem>
