...
const resume = (state={
  ...
  experience: {
    educationRecords: [  // Experience以后还会增加工作经历、项目经历
      {
        school: '华中科技大学',
        degree: '硕士',
        major: '软件工程',
  ...
  switch (action.type) {
    ...
    case 'SUBMIT_SKILL':
      const newObj = Object.assign({}, action.values, {skills: action.values.skills.tags});
      return Object.assign(state, {skill: newObj});
    case 'SUBMIT_EXPERIENCE':
      return Object.assign(state, { experience: {educationRecords: action.values} });
