...
export class SelfIntro extends React.Component {
  state = {
    importContent: this.props.storeValue.content ? this.props.storeValue.content : '请在此填写个人描述',
    content: ''
  };

  handleSubmit = () => {  // SelfIntro用的Redux dispatch也是onFormSubmit，虽然意思有些混乱，但方便一点
    ...
    return (
      <div>
        ...
        <Row type={'flex'} justify={'space-between'} style={{marginTop: '15px'}}>
          <Button icon="plus" onClick={this.insertTemplate}>插入模板</Button>
          <Button type="primary"
